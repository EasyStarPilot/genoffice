...
export const OPENABLE_DOC_RE = /\.(docx|odt|xlsx|xlsm|xls|csv|ods|pptx|odp|pdf|md|markdown)$/i
...
export const KNOWN_UNSUPPORTED_DOC_RE = /\.(doc|rtf|ppt|pps|xlsb|pages|key|numbers)$/i
